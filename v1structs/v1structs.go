...
type GetTeamRosterResponse struct {
	...
	// [DEPRECATED: use `Rosters` instead]
	// TeamRoster describes the members and configuration of a team.
	// See github.com/fluidkeys/fluidkeys/teamroster
	TeamRoster string `json:"teamRoster"`
	...
	// Rosters is a list of versions of the team roster and signature, ordered by the
	// roster version number (oldest to newest).
	Rosters []TeamRosterAndSignature
}
